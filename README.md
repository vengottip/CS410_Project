...
When testing our app, the results (retrieved tweets, topic and terms, sentiment distribution) you obtain with the same query may differ from those shown in our demo, because we have expanded our dataset since the demo was created. However, all functionalities remain unchanged.
